...
<body>
    <div class="card">
        ...
        <h1 class="name">Florence</h1>
        <p class="title">Medical AI Research</p>
        <div class="divider"></div>
        <p class="bio">
            안녕하세요! 저는 Florence입니다.<br>
            의료 인공지능을 연구하고 있어요.<br><br>
            만나서 반갑습니다!
        </p>
        <div class="contact">
            <a href="mailto:ncc.cjp@gmail.com">이메일</a>
        </div>
